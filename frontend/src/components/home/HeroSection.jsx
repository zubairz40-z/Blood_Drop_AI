...
function HeroSection() {
  ...
  return (
    <section className="relative pt-16 overflow-hidden">
      <div className="relative min-h-[85vh] flex items-center rounded-b-[0.5rem] overflow-hidden bg-neutral-900">
        <div className="absolute inset-0">
          <img src={healthcareImage} alt="" aria-hidden="true" className="absolute inset-0 h-full w-full object-cover" />
          <div className="absolute inset-0 bg-gradient-to-br from-neutral-900/95 via-neutral-900/75 to-neutral-900/95" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 w-full">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-3">
              {highlights.map((item) => (
                <div key={item.text} className="flex items-center gap-2 text-sm text-neutral-400">
